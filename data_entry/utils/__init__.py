...
def patients_csv_headers():
    ...
    return '\ufeff' + ', '.join([
        ...
        'GENDER',
        'WEIGHT(kg)',
        'PCI-RISK-MULTI-VESSEL PCI',
        'PCI-RISK-MULTIPLE STENTS IMPLANTED (>3 STENTS IMPLANTED. <3 LESIONS STENTED)',
        'PCI-RISK-COMPLEX BIFURCATION LESION (TREATED WITH 2 STENTS)',
        'PCI-RISK-TOTAL STENT LENGTH > 60MM',
        'PCI-RISK-CHRONIC TOTAL OCCLUSION INTERVENTION',
