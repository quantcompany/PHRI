...
def patients_csv_headers():
    ...
    return '\ufeff' + ', '.join([
        ...
        'GENDER',
        'WEIGHT(kg)',
        'HIGH-RISK-AF - MULTI-VESSEL PCI',
        'HIGH-RISK-AF - MULTIPLE STENTS IMPLANTED (>3 STENTS IMPLANTED. <3 LESIONS STENTED)',
        'HIGH-RISK-AF - COMPLEX BIFURCATION LESION (TREATED WITH 2 STENTS)',
        'HIGH-RISK-AF - TOTAL STENT LENGTH > 60MM',
        'HIGH-RISK-AF - TOTAL OCCLUSION INTERVATION',
        'HIGH-RISK-AF - BIOABSORBABLE VASCULAR SCAFFOLD (MVS) IMPLANTATION',
        'HIGH-RISK-AF - LEFT MAIN OR PROXIMAL LAD STENTING',
        'INDICATION',
